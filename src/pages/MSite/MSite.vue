...
<template>
<section class="msite">
  <header-nav :title="address.name">
    <router-link class="header_search" slot="left" to="/search">
      <i class="iconfont icon-sousuo"></i>
    </router-link>
    <router-link class="header_login" slot="right" :to="userInfo._id?'/profile':'/login'">
      <span class="header_login_text">{{userInfo._id?userInfo.name||userInfo.phone:'登录|注册'}}</span>
    </router-link>
  </header-nav>
  <!--首页导航-->
  <nav class="msite_nav">
    ...
    <img src="./msite_back.svg" alt="msite_back" v-else>
  </nav>
  <!--首页附近商家-->
